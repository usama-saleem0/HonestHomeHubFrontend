    ...
    <div className="classname30211">
      ...
      <Stack
        ...
        style={{
          ...
          // width: "100%", // Corrected
          borderRadius: "20px", // Added quotes
          background: "#1AC1F3",
      ...
      >
        <Box
          sx={{
            ...style,
            width: { md: "40%", lg: "40%", sm: "60%", xs: "80%" },
            height: { md: "50%", lg: "50%", sm: "50%", xs: "50%" },
            overflowY: "scroll",
          }}
          className="scroll_content scroll-remove"
          justifyContent={"center"}
            ...
            >
              ...
              <div className="ibrar">
                <div className="ibrar-BSDK">
                  ...
                  >
                    {" "}
                    Our pricing structure entails a 20% fee applied to cleaning
                    and landscaping services, with a 10% fee applied to all
                    other types of jobs.
                  </Stack>
                </div>
              </div>
