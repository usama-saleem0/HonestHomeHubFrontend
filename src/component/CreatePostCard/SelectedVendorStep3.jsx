        ...
        <p>{e.status} </p> */}
                      ...
                      <div class="sh-list-2">
                        <span>
                          ...
                          <p>
                            Job Date :
                            {/* {e.date === '2000-01-01' ? e.cleaning_maintainance_date.split(' ')[0]:'---'}  */}
                            {/* {e.date === "2000-01-01" ? (e.cleaning_maintainance_date?new Date(e.cleaning_maintainance_date.split("T")[0]).toLocaleDateString('en-US', {
                                year: 'numeric',
                                month: 'long',
                                day: 'numeric'
                              })   e.cleaning_maintainance_date?formatTime(e.cleaning_maintainance_date.split("T")[1]) )
