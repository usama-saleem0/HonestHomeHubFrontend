...
const SelectedVendor = ({ job_id1 }) => {
  ...
  return (
    <div className="select_qoutes_step3 select--quotes--step--3--h">
      <div className="classname-440 classname--440--alt--h RR ">
            ...
            <div className="darshan1">
              ...
              <Stack key={i}>
                {e.jobId === TS && e.status === "selected" && (
                  ...
                  <div class="sh-card sh--card--alt--h--2">
                    <div class="sh-box-1">
                      <div class="sh-list-1">
                      ...
                      <div class="sh-list-2">
                        <span>
                          ...
                          <p>
                            Job Date :{" "}
                            {e.date === "2000-01-01"
                              ? e.cleaning_maintainance_date.split(" ")[0]
                              : "---"}{" "}
                          </p>
                        </span>
